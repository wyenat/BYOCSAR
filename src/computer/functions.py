def get_register(value):
    return int("0x"+value, 16)//8 -1

def get_value(value):
    return int("0x"+value, 16)%8
...
def div(value, computer):
    computer.registers[get_register(value)].value = computer.registers[get_register(value)].value // get_value(value)
